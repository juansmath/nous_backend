# Generated by Django 3.1.5 on 2021-10-13 21:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_banco', models.CharField(max_length=100, unique=True, verbose_name='Nombre del banco de preguntas')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_actualizacion', models.DateField(auto_now=True, verbose_name='Fecha de actualizacion')),
                ('fecha_eliminacion', models.DateField(auto_now=True, verbose_name='Fecha deeliminación')),
                ('nombre_competencia', models.TextField(verbose_name='Nombre de la competencia')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_actualizacion', models.DateField(auto_now=True, verbose_name='Fecha de actualizacion')),
                ('fecha_eliminacion', models.DateField(auto_now=True, verbose_name='Fecha deeliminación')),
                ('letra', models.CharField(choices=[('A', 'A'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('E', 'E'), ('F', 'F'), ('G', 'G'), ('H', 'H'), ('I', 'I'), ('J', 'J'), ('K', 'K'), ('L', 'L'), ('M', 'M'), ('N', 'N'), ('O', 'O'), ('P', 'P'), ('R', 'R'), ('S', 'S'), ('T', 'T'), ('U', 'U'), ('V', 'V'), ('W', 'W'), ('X', 'X'), ('Y', 'Y'), ('Z', 'Z')], max_length=1, unique=True, verbose_name='Letra')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modulo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prueba.modulo')),
                ('nivel_dificultad', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prueba.niveldificultad')),
                ('respuesta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prueba.opcionesletras')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('letra', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prueba.opcionesletras')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estudiante', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='estudiante.estudiante')),
                ('opcion_marcada', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='prueba.opcionesletras')),
                ('pregunta', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='prueba.pregunta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('respuesta', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='prueba.opcionesletras')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('letra', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='prueba.opcionesletras')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estudiante', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='estudiante.estudiante')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('opcion_marcada', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='prueba.opcionesletras')),
                ('pregunta', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='prueba.pregunta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_actualizacion', models.DateField(blank=True, editable=False, verbose_name='Fecha de actualizacion')),
                ('fecha_eliminacion', models.DateField(blank=True, editable=False, verbose_name='Fecha deeliminación')),
                ('nombre_banco', models.CharField(db_index=True, max_length=100, verbose_name='Nombre del banco de preguntas')),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
